...
func Init(cfg *settings.LogConfig, mode string) (err error) {
	writeSyncer := getWriteSyncer(cfg.Filename, cfg.MaxSize, cfg.MaxBackups, cfg.MaxAge)
	encoder := getEncoder()
...
// 加入Lumberjack，进行日志切割归档
func getWriteSyncer(filename string, maxSize, maxBackup, maxAge int) zapcore.WriteSyncer {
